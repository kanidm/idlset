//! Version 1 of IDLSet - This is a compressed-only version of the library. This
//! should be used when you know your data set is always large and compresses well.
//! There are a number of cases where with small (IE less than 8) items from one
//! set interacting with a larger set (IE thousands of items) that uncompressed
//! indexes will perform better.
//!
